...
//		}
	...
	public CommandLineRunner demo(UserRepository repository) {
		return(args)->{
			...
			repository.save(new User("p1","Haritha","Chennai",0));
			repository.save(new User("p2","Sona","Chennai",0));
			repository.save(new User("p3","Sangeetha","Chennai",0));
			repository.save(new User("p4","Sneha","Chennai",0));
			repository.save(new User("p5","Arthi","Chennai",0));
